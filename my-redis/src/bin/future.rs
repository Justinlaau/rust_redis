...
fn main() {
    ...
    mini_tokio.spawn(async {
        ...
        println!("my third delay got called");
...
impl Task {
    ...
    fn poll(self: Arc<Self>) {
        ...
        // Poll the future
        let x = future.as_mut().poll(&mut cx);
        println!("{:?}", x);
    }
}
